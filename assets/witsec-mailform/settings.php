...
$_SETTINGS = [
	"to"						=> "contato@sergiocardoso.org",							// To Address
	"toAlt"						=> "",						// Additional Recipients
	"from"						=> "contato@sergiocardoso.org",						// From Address
	...
	"template"					=> "Ola, chegou uma mensagem do site Bazaar<br><br>{formdata}<br><br>Date: {date}<br>Remote IP: {ip}<br><br>---<br>Have a nice day.",					// Mail Template
